...
const (
	Payment_ProcessPayment_FullMethodName = "/payment.Payment/ProcessPayment"
)
...
func (c *paymentClient) ProcessPayment(ctx context.Context, in *PaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
...
func (UnimplementedPaymentServer) ProcessPayment(context.Context, *PaymentRequest) (*PaymentResponse, error) {
